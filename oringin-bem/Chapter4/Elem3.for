      SUBROUTINE ELEM3(XP,YP,ZP,XQ,YQ,ZQ,H,G,CP)
C
C  Formulate element coefficient vectors for a triangular element
C
      COMMON /FRE/FREQ,WN
      DIMENSION XII(12),WT(12)
      DIMENSION XQ(4),YQ(4),ZQ(4),QN(3),PSI(4),DPSI(2,4)
      DIMENSION H(4),G(4)
      REAL NN1,NN2,NN3
...
200       CONTINUE
	  ...
	  RZ=ZZ-ZP
          ...
          FACTOR=DETJ*WT(INP1)*WT(INP2)*0.25*RHO
